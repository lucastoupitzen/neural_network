...
for fold in range(5, 10):
    ...
    X, y, Xv, Yv = read_database_cross_validation(index=fold)
    ...
    while True:
        ...
        acuracia, erro_teste = testing(hidden_neurons=number_of_neurons, validation_input=Xv, validation_output=Yv, fold= fold) # retorna a acurácia do modelo
    ...
    testing(isFinal=True, hidden_neurons=number_of_neurons, validation_input=Xv, validation_output=Yv, fold= fold)
    ...
    pdf.output(f'report_fold_{fold}.pdf', 'F')